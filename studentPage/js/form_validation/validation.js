...
Validation
		.addAllThese( [
				...
				[
						...
						function(v) {
							return Validation.get('IsEmpty').test(v)
									|| /^(01|02|03|05|070|071|072|073|074|075|07624|077|078|079|\+|00)[0-9]+$/.test(v) && /^.{10,14}$/.test(v)
							} ],
				...
				[
						'validate-alpha',
						'Please use letters only (A-Z, a-z) here.',
						function(v) {
							return Validation.get('IsEmpty').test(v)
									|| /^[a-zA-Z]+$/.test(v) || /[ \t]+/.test(v)
						} ],
				[
						'validate-alphanum',
				...
				[
						'validate-url',
						'Please enter a valid URL. Begin with http:// or https://',
						function(v) {
							return Validation.get('IsEmpty').test(v)
				...
				[
						'validate-date-au',
						'Please use this date format: dd/mm/yyyy. For example 27/03/2010 for the 27th of March, 2010.',
						function(v) {
